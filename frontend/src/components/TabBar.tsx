...
export function TabBar() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-40 border-t border-black/5 bg-tg-secondary-bg/95 px-6 pb-[calc(env(safe-area-inset-bottom,0px)+0.75rem)] pt-3 backdrop-blur-xl">
